...
tipo = sys.argv[8]              # tipo del bot //1 -> arbol de decision, 2 -> preguntas frecuentes, 3-> pasos secuencia
...
#"Árbol de decisión", "Árbol de decisión con botones", "Preguntas Frecuentes", "Secuencia de Pasos"
if tipo == "1" or tipo == "2":
